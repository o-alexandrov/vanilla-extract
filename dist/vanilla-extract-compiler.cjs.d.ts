...
declare const createCompiler: ({ root, identifiers, cssImportSpecifier, unstable_splitCssPerRule: splitCssPerRule, cssFileFilter: fileFilter, viteConfig, enableFileWatcher, viteResolve, vitePlugins, }: CreateCompilerOptions) => Compiler;
