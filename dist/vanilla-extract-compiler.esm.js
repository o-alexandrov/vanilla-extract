...
import { serializeVanillaModule, normalizePath, cssFileFilter, getPackageInfo, transform } from '@vanilla-extract/integration';
...
const createCompiler = ({
  ...
  return {
    ...
    async findImporterTree(filePath, transformedModules) {
      ...
      // modules
      const moduleNode = server.moduleGraph.getModuleById(normalizePath(filePath));
      if (!moduleNode) {
        return new Set();
      }
